...
const STORAGE_KEY = "finance_ai_workspace_chats_v1";
  ...
  return [
    {
      ...
      time: nowTime(),
      text:
        "Welcome to the full AI Finance Workspace. I can help with overdue customer summary, follow-up priority, vendor dues, aging report navigation, statement navigation, ledger navigation, invoice navigation, purchase bill navigation, and payment reminder drafting.",
      cards: [
        {
          type: "summary",
...
Accounts Team`;
  ...
  async function handleSend(customText) {
    ...
    try {
      const result = await buildRealResponse(finalText);
            ...
            <div style={panelHeader}>
              <div>
                ...
                <div style={panelSubtitle}>
                  Finance actions, summaries, reminders, and chat history
                </div>
              </div>
