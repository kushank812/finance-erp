...
export default function ReceiptView() {
  const { receiptNo } = useParams(); // this is actually invoiceNo in your design
  ...
  useEffect(() => {
    (async () => {
      ...
      setLoading(true);
      try {
        const data = await apiGet(`/sales-invoices/${encodeURIComponent(receiptNo)}`);
        setInv(data);
      } catch (e) {
