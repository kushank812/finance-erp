...
export default function VendorMaster() {
  ...
  function handleVendorNameChange(value) {
    update("vendor_name", alphaNumericBasic(value, 200));
  }
  ...
  function normalizePayloadValues(source) {
    return {
      vendor_name: upper(source.vendor_name).trim(),
      vendor_address_line1: upper(source.vendor_address_line1).trim(),
      vendor_address_line2: upper(source.vendor_address_line2).trim(),
      vendor_address_line3: upper(source.vendor_address_line3).trim(),
  ...
  function loadIntoForm(row, nextMode = "view") {
    ...
    setForm({
      ...
      vendor_name: upper(row.vendor_name ?? ""),
      vendor_address_line1: upper(row.vendor_address_line1 ?? ""),
      vendor_address_line2: upper(row.vendor_address_line2 ?? ""),
      vendor_address_line3: upper(row.vendor_address_line3 ?? ""),
      city: upper(row.city ?? ""),
        ...
        <div style={sectionBlock}>
          ...
          <div style={formGrid3}>
            <FormField
              ...
              onChange={(e) =>
                handleAddressChange("vendor_address_line1", e.target.value)
              }
              readOnly={!canWrite}
            />
            <FormField
              ...
              onChange={(e) =>
                handleAddressChange("vendor_address_line2", e.target.value)
              }
              readOnly={!canWrite}
            />
            <FormField
              ...
              onChange={(e) =>
                handleAddressChange("vendor_address_line3", e.target.value)
              }
              readOnly={!canWrite}
            />
          </div>
